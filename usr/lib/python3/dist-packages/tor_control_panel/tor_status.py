...
def set_enabled():
    ...
    command = 'leaprun tcp-tor-control-restart'
    ...
    command = 'leaprun tcp-tor-control-reload'
    subprocess.call(command, shell=True)

    command = 'leaprun tcp-tor-control-status'
    tor_status_code = subprocess.call(command, shell=True)
...
def set_disabled():
    ...
    command = 'leaprun tcp-tor-control-stop'
    subprocess.call(command, shell=True)
